...
{
    public partial class frmGeneralReport : Telerik.WinControls.UI.RadForm
    {
        public frmGeneralReport()
        {
            InitializeComponent();
            DataSet ds = SQLHelper.ExecuteDataset(SQLHelper.createConnection(), CommandType.StoredProcedure, "App.USP_GeneralReport", new SqlParameter("@Task", "ReportAllData"));
        ...
        private void radTreeView1_NodeMouseClick(object sender, Telerik.WinControls.UI.RadTreeViewEventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(ReportName))
                {
                    ...
                    DataSet ds = SQLHelper.ExecuteDataset(SQLHelper.createConnection(), CommandType.StoredProcedure, "App.USP_GeneralReport", param);
