...
{
    public partial class AccountStatementforNewCustomer : Telerik.WinControls.UI.RadForm
    {
        public AccountStatementforNewCustomer()
        {
            InitializeComponent();
        }
        ...
        private bool AccountStatmentView()
        {
            ...
            dst = Helper.SQLHelper.ExecuteDataset(Helper.SQLHelper.createConnection(), CommandType.StoredProcedure, "App.USP_AccountStatmentforNewCustomer", prm);
        ...
        private void btnAccountStatmentView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((FileStatus == "0") || (clsUser.ID == 3) || (clsUser.ID == 35))
                {
                    if (FileStatus == "1")
                    {
                        lblFileStatus.Text = "Block";
        ...
        private void AccountStatementforNewCustomer_Load(object sender, EventArgs e)
        {
