...
{
    public partial class frmSMSForGeneralPurpose : Telerik.WinControls.UI.RadForm
    {
        public frmSMSForGeneralPurpose()
        {
            InitializeComponent();
        }
        ...
        private void btnmobilenumers_Click(object sender, EventArgs e)
        {
            SqlParameter[] parameter = {
                            new SqlParameter("@Task","GetMobileNoDataForSMS"),
        ...
        {
                lblTotalSMS.Text = lbltotalcount.Text;
            ...
            try
            {
                ...
                foreach (DataRow Row in MobileNods.Tables[0].Rows)
                {
                    if (Regex.IsMatch(Row["MobileNo"].ToString(), MakeCombinedPattern()))
                    {
                        ...
                        ////////////old message
                        //string smsmesaage = "Dear Customer;" +Environment.NewLine+
                        //              "Last date to deposit Down Payment against your "+ Row["PlotSize"].ToString() 
                        //              + " Commercial file no. " + Row["FileNo"].ToString()  + " is 01 Dec 2020." +Environment.NewLine+
                        //              "Please deposit your due amount to avoid any inconvenience." + Environment.NewLine +
                        //              "Best Wishes." + Environment.NewLine +
                        //              "DHA Peshawar.";
                        ///////////////////////////
                        ...
                        string smsmesaage = "Dear Customer," + Environment.NewLine +
                                      "Your Down Payment against your " + Row["PlotSize"].ToString()
                                      + " Commercial file no. " + Row["FileNo"].ToString() + " is overdue." + Environment.NewLine +
                                      "Please clear your outstanding dues to avoid inconvenience." + Environment.NewLine +
                                      "Best Wishes." + Environment.NewLine +
                                      "DHA Peshawar.";
                        ...
                        status = SMSSEndingNEW(Row["MobileNo"].ToString(), smsmesaage);
                     ...
                     SqlParameter[] parameter = {
                         ...
                         new SqlParameter("@Message",smsmesaage),
                         ...
                         new SqlParameter("@UserName",clsUser.Name)
                            ...
                            if (ds.Tables.Count > 0)
                            {
                                ...
                                {
                                    string data = @"" + Row["MobileNo"].ToString() + "|" + txtSMSType.Text + "|" + smsmesaage + "|" + status.ToString() + "|" + clsUser.Name + DateTime.Now.ToString("dd/MMM/yyyy-hh:MM:ss tt") + "\n";
