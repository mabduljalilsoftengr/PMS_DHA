...
namespace PeshawarDHASW.Helper
{
    class SQLHelper
    {
        ...
        public static SqlConnection ImagecreateConnection()
        {
            try
            {
                string strConnString = MainConnections.ConnectionString_MainServer; //System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionStringImage"].ToString();
        ...
        public static SqlConnection createConnection()
        {
            try
            {
                string strConnString = MainConnections.ConnectionString_MainServer;// System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
                                                                                   //string strConnString = _configReader.GetValue("Main.ConnectionString", "".GetType()).ToString().Trim();
                                                                                   //ConfigurationManager.ConnectionStrings("Main.ConnectionString").ConnectionString.ToString()
                SqlConnection myConnection = new SqlConnection(strConnString);
                myConnection.Open();
        ...
        public static SqlConnection createConnectionLogging()
        {
            try
            {
                string strConnString = MainConnections.ConnectionString_Logging;   //System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
                                                                                   //string strConnString = _configReader.GetValue("Main.ConnectionString", "".GetType()).ToString().Trim();
                                                                                   //ConfigurationManager.ConnectionStrings("Main.ConnectionString").ConnectionString.ToString()
                SqlConnection myConnection = new SqlConnection(strConnString);
                myConnection.Open();
        ...
        public static SqlConnection createConnection_ComplaintMgt()
        {
            try
            {
                string strConnString = MainConnections.ConnectionString_ComplaintMgt;// System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
                                                                                   //string strConnString = _configReader.GetValue("Main.ConnectionString", "".GetType()).ToString().Trim();
                                                                                   //ConfigurationManager.ConnectionStrings("Main.ConnectionString").ConnectionString.ToString()
                SqlConnection myConnection = new SqlConnection(strConnString);
                myConnection.Open();
        ...
        public static SqlConnection createConnection_DHADB()
        {
            try
            {
                string strConnString = MainConnections.ConnectionString_MainServer_DHADB;// System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
                                                                                         //string strConnString = _configReader.GetValue("Main.ConnectionString", "".GetType()).ToString().Trim();
                                                                                         //ConfigurationManager.ConnectionStrings("Main.ConnectionString").ConnectionString.ToString()
                SqlConnection myConnection = new SqlConnection(strConnString);
                myConnection.Open();
        ...
        //Sql Transaction Base Sql Command Execution
        public static SqlCommand ExecuteNonQuery(SqlTransaction sqlTran, CommandType commandType, string commandText, string a, SqlParameter[] commandParameters)
        {
            ...
            PrepareCommand(cmd, sqlTran.Connection, sqlTran, commandType, commandText, commandParameters);
        ...
        //ExecuteNonQuery
        public static bool ExecuteNonQuery(SqlTransaction _trans, List<SqlCommand> _Command, List<object> _SqlParameter)
        {
            bool status = false;
