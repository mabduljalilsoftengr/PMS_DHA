    ...
    public partial class MainRibbonForm : Telerik.WinControls.UI.RadRibbonForm
    {
       ...
       Application_Layer.Launching.ApplicationObservation_L2  frmapplicationObsrobj;
        ...
        private void radbtnLogout_Click(object sender, EventArgs e)
        {
            ...
            {
                // Hide the current main form (instead of closing the app)
                this.Hide();
                ...
                // When the login form closes, close this form too
                loginForm.FormClosed += (s, args) => this.Close();
            }
        }

        #region PHP
        private frmPHP objfrmPHP;
        private void radBtnPHP_Click(object sender, EventArgs e)
        {
            if (objfrmPHP ==null)
            {
                objfrmPHP = new frmPHP();
                objfrmPHP.MdiParent = this;
                objfrmPHP.WindowState = FormWindowState.Minimized;
                objfrmPHP.FormClosed += ObjfrmPHP_FormClosed;
                radDock1.ActivateMdiChild(objfrmPHP);
                objfrmPHP.Show();
            }
            else
            {
        ...
        private void ObjfrmPHP_FormClosed(object sender, FormClosedEventArgs e)
        {
            objfrmPHP = null;
        }

        Application_Layer.OpenTransfer.frmOpenTransfer opentransfer;
        private void OpenTransferList1_Click(object sender, EventArgs e)
        {
            if (opentransfer == null)
            {
                opentransfer = new Application_Layer.OpenTransfer.frmOpenTransfer();
        ...
        Application_Layer.Amalgamation.frmApprovedAmalgamation approvalAmalgamation;
        private void btnApprovedAmalg_Click(object sender, EventArgs e)
        {
            if (approvalAmalgamation == null)
            {
                approvalAmalgamation = new Application_Layer.Amalgamation.frmApprovedAmalgamation();
                approvalAmalgamation.MdiParent = this;
                approvalAmalgamation.WindowState = FormWindowState.Maximized;
                approvalAmalgamation.FormClosed += ApprovalAmalgamation_FormClosed;
                radDock1.ActivateMdiChild(approvalAmalgamation);
                approvalAmalgamation.Show();
            }
            else
            {
                approvalAmalgamation = null;
            }
        }

        private void ApprovalAmalgamation_FormClosed(object sender, FormClosedEventArgs e)
        {
            approvalAmalgamation = null;
        }
        //private void Opentransfer_FormClosed(object sender, FormClosedEventArgs e)
