        ...
        private void btnsavefile_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    if (dsFile.Tables[0].Rows.Count == 0)
                    {
                        ...
                        SqlParameter[] parameters =
                        {
                               ...
                               // new SqlParameter("@TemplateInstKey",ddlInstallmentTemplate.SelectedValue),
                                ...
                                new SqlParameter("@InvestorName",clsPluginHelper.DbNullIfNullOrEmpty(txtInvestName.Text)),
                        ...
                        bool rslt1 = clsPluginHelper.ApplicationLogSaving(txtfileno.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Insertion - In File ", parameters, "frmCreateFileNoRPlot - btnsavefile_Click", "SQLParam");
                ...
                else
                {
                   ...
                   bool rslt = clsPluginHelper.ApplicationLogSaving(txtfileno.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "After - Modification in File No.", parameters, "frmCreateFileNoRPlot - btnsavefile_Click", "SQLParam");
        ...
        private void loadfill(int ID)
        {
            try
            {
                ...
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    bool rslt = clsPluginHelper.ApplicationLogSaving(txtfileno.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Before - Modification in File No.", ds, "Select the File data before updateion","DataSetTable");
                }
            }
            catch (Exception ex)
            {
