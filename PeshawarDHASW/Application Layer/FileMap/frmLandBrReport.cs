...
{
    public partial class frmLandBrReport : Telerik.WinControls.UI.RadForm
    {
        public frmLandBrReport()
        {
            InitializeComponent();

            DataSet ds = SQLHelper.ExecuteDataset(SQLHelper.createConnection(), CommandType.StoredProcedure, "App.USP_LandBrReport", new SqlParameter("@Task", "ReportAllData"));
        ...
        private void frmLandBrReport_Load(object sender, EventArgs e)
        {
        ...
        private void radTreeView1_NodeMouseClick(object sender, RadTreeViewEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(ReportName))
                {
                    ...
                    DataSet ds = SQLHelper.ExecuteDataset(SQLHelper.createConnection(), CommandType.StoredProcedure, "App.USP_LandBrReport", param);
