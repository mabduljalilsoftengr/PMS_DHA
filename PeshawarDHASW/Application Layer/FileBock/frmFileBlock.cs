...
namespace PeshawarDHASW.Application_Layer.FileBock
{
    public partial class frmFileBlock : Telerik.WinControls.UI.RadForm
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            //bool rslt = clsPluginHelper.ApplicationLogSaving(txtFileNo.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Before - Modification of File Lock Status ", ds, "frmFileBlock - btnFind_Click", "DataSetTable");
