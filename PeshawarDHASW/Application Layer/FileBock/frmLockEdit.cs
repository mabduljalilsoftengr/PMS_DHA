...
namespace PeshawarDHASW.Application_Layer.FileBock
{
    public partial class frmLockEdit : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmLockEdit(Telerik.WinControls.UI.GridViewCellEventArgs data)
        {
            ...
            //{
            //    data.Row.Cells["FileMapKey"].Value.ToString(),
            //    data.Row.Cells["FileNo"].Value.ToString(),
            //    data.Row.Cells["PlotNo"].Value.ToString(),
            //    data.Row.Cells["MemberName"].Value.ToString(),
            //    data.Row.Cells["Father"].Value.ToString(),
            //    data.Row.Cells["FileLock"].Value.ToString(),
            //    data.Row.Cells["LockRemarks"].Value.ToString()
            //};
            var values = new List<string>
            {
                "FileMapKey=" + data.Row.Cells["FileMapKey"].Value.ToString(),
                "FileNo=" + data.Row.Cells["FileNo"].Value.ToString(),
                "PlotNo=" + data.Row.Cells["PlotNo"].Value.ToString(),
                "MemberName=" + data.Row.Cells["MemberName"].Value.ToString(),
                "Father=" + data.Row.Cells["Father"].Value.ToString(),
                "FileLock=" + data.Row.Cells["FileLock"].Value.ToString(),
                "LockRemarks=" + data.Row.Cells["LockRemarks"].Value.ToString()
            };


            bool rslt = clsPluginHelper.ApplicationLogSaving(txtFileNo.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Before - Modification of File Lock Status ", values, "frmFileBlock - btnFind_Click", "DataSetTable");
        ...
        private void btnSaveChanges_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool rslt = clsPluginHelper.ApplicationLogSaving(txtFileNo.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "After - Modification File Lock Status ", param, "frmLockEdit - btnSaveChanges_Click", "SQLParam");
