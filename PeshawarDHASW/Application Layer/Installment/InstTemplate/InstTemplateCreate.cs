    ...
    public partial class InstTemplateCreate : Telerik.WinControls.UI.RadForm
    {
        ...
        private void SavingclsInstallmentTemplate()
        {
            try
            {
                ...
                bool rslt = clsPluginHelper.ApplicationLogSaving("", Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Insertion in Installment Template", parameters, "InstTemplateCreate - radbtnCreateTemplateInst_Click", "SQLParam");
                if (result > 0)
                {
