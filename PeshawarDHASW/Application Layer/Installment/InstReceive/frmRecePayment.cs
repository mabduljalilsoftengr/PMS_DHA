            ...
            try
            {
                if (FileActiveNotBlock() == true)
                {
                    ...
                    if (txtfileno.Text != "" || txtplotno.Text != "" || txtmsno.Text != "" || txtnic.Text != "" || txtplotno.Text != "")
                    {
                        ...
                        bool rslt = clsPluginHelper.ApplicationLogSaving(txtfileno.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Before - Modification in the Received Discount", ds, "frmRecePayment - btnsearch_Click", "DataSetTable");
                    ...
                    if (txtbank.Text != "-- Select Bank --")
                    {
                        if (MessageBox.Show("Do you want to Save", "Attention", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                        {
                            ...
                            if (DDAmount >= surAmount)
                            {
                                ...
                                bool rslt = clsPluginHelper.ApplicationLogSaving(fileNO, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "After - Modification in the Received Discount ", prmt, "frmRecePayment - btnsave_Click", "SQLParam");
                    ...
                    if (txtbank.Text != "-- Select Bank --")
                    {
                        ...
                        if (Helper.clsMostUseVars.Drctr_Secret_Code == true)
                        {
                            if (MessageBox.Show("Do you want to Save", "Attention", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                            {
                                ...
                                int rsult = Data_Layer.Installment.cls_dl_FinanceDashBoard.AccountStatement_RecePlanAdjust(prmt);
                                //DataSet ds = cls_dl_FinanceDashBoard.AccountStatement_RecePlanAdjust(prmt);
