        ...
        private void radbbtnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    bool rslt = clsPluginHelper.ApplicationLogSaving(FileNo, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Insertion in Installment Plan ID : ", param, "frmInstPlanCreate - radbbtnsave_Click", "SQLParam");
