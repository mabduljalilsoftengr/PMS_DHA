...
{
    public partial class frmNDCCreate : Telerik.WinControls.UI.RadForm
    {
        ...
        private bool buyerCheckLateFiler { get; set; } = false;
        private bool buyerCheckNonFiler { get; set; } = false;
        private bool sellerrCheckFiler { get; set; } = false;
        private bool sellerrCheckLateFiler { get; set; } = false;
        ...
        {
            InitializeComponent();
            dtpNDCExpire.MinDate = DateTime.Now;
        }

        public frmNDCCreate(int get_NDCID)
        {
            NDCID = get_NDCID;
            InitializeComponent();
        }
        ...
        public frmNDCCreate(int get_NDCID, bool datagroup)
        {
            try
            {
                NDCID = get_NDCID;
                ...
                if (groupdata == false)
                {
                    btnNDCCreate.Visible = groupdata;
                    txtFile_No.Enabled = groupdata;
                    //btn_File_Verify.Enabled = groupdata;
                    //rgbFileNo.Enabled = groupdata;
                    //rgbNdcInfo.Enabled = groupdata;
                }
                else
                {
        ...
        {
            //drp_stmdtRef.Items.Clear();
            //RadListDataItem select = new RadListDataItem();
            //select.Value = 0;
            //select.Text = "";
            //drp_stmdtRef.Items.Add(select);      //drp_Plano_PlanWiseSearch
            SqlParameter[] prm =
            {
            ...
            //foreach (DataRow row in cls_dl_StampDuty.StampDuty_Reader(prm).Tables[0].Rows)
            //{
            //    RadListDataItem dataItem = new RadListDataItem();
            //    dataItem.Value = row["StmpDuty_ID"].ToString();
            //    dataItem.Text = row["RefNo"].ToString();
            //    drp_stmdtRef.Items.Add(dataItem);
            //}
            //drp_stmdtRef.SelectedIndex = 0;
            //drp_stmdtRef.Enabled = true;
        }
        //NDC Create
        ...
        //    //try
        //    //{
        //    //    SqlParameter[] NDCChecking =
        //    //    {
        //    //        new SqlParameter("@Task", "PreventAgainApply"),
        //    //         new SqlParameter("@FileKey",FileKeyID),
        //    //    };

        //    //    DataSet dsNDCChecking = cls_dl_NDC.NdcRetrival(NDCChecking);
        //    //    if (dsNDCChecking.Tables[0].Rows.Count == 0)
        //    //    {
        //    //        SqlParameter[] NDCDays =
        //    //        {
        //    //          new SqlParameter("@Task", "PreventAgainApplyDate"),
        //    //          new SqlParameter("@FileKey",FileKeyID),
        //    //        };

        //    //        DataSet dsNDCDay = cls_dl_NDC.NdcRetrival(NDCDays);
        //    //        if (dsNDCDay == null)
        //    //        {
        //    //            createNDC();
        //    //        }
        //    //        if (dsNDCDay != null)
        //    //        {
        //    //            if (dsNDCDay.Tables[0].Rows.Count <= 0)
        //    //            {
        //    //                createNDC();
        //    //            }
        //    //        }
        //    //        else
        //    //        {
        //    //            MessageBox.Show("NDC is Not Expire");
        //    //        }
        //    //    }

        //    //    else
        //    //    {
        //    //        MessageBox.Show("Application is Already Exists.");
        //    //    }

        //    //}
        //    //catch (Exception ex)
        //    //{
        //    //    cls_dl_ErrorLog.ErrorLogSAvetoDB(ex, "Saving New NDC");
        //    //}
        //}

        //private void createNDC()
        //{
        //    SqlParameter[] parameter =
        //                  {
        //                        new SqlParameter("@Task", "insert"),
        //                        new SqlParameter("@MemberID", MSID),
        //                        new SqlParameter("@DateIssue", lbldateofissue.Text),
        //                        new SqlParameter("@DateofExprie", lbldateofexpiry.Text),
        //                        new SqlParameter("@CopyofIntimationLetter",  CheckboxCheck(chkintletter)),
        //                        new SqlParameter("@AttesstedCNICSellPurchaser",
        //                             CheckboxCheck(chkattestedcnic)),
        //                        new SqlParameter("@Stumpduty",  CheckboxCheck(chkstampduty)),
        //                        new SqlParameter("@GainTax",  CheckboxCheck(chkgaintext)),
        //                        new SqlParameter("@NDCApplication",  CheckboxCheck(chkndcapplication)),
        //                        new SqlParameter("@Status", "Pending"),
        //                        new SqlParameter("@FileNo", lblfileno.Text),
        //                        new SqlParameter("@FileKey", FileKeyID),
        //                        new SqlParameter("@userID", clsUser.ID),
        //                        new SqlParameter("@Remarks", txtremarks.Text),
        //                        new SqlParameter("@RemarkClean",  CheckboxCheck(chkRemarkClear))
        //                    };
        //    int result = cls_dl_NDC.NdcModify(parameter);
        //    if (result > 0)
        //    {
        ...
        //    }
        //}
        private void frmNDCCreate_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (NDCID == 0)
                {
                    ...
                    grp_SaveButton.Enabled = false;
                    dtpIssueDate.Value = DateTime.Now;
                    dtpNDCExpire.Value = DateTime.Now.AddDays(30);
        ...
        private void BindColumnToFBRSellerBuyerCPRDetailGrid()
        {
            ...
            foreach (GridViewRowInfo row in grdSeller_Buyer.Rows)
            {
                ...
                if (!string.IsNullOrEmpty(row.Cells["NTN"].Value.ToString()))
                {
                    ...
                    if (dst1.Tables.Count > 0)
                    {
                        if (dst1.Tables[0].Rows.Count > 0)
                        {
                            ...
                            else if (dst1.Tables[0].Rows[0]["Type"].ToString() == "Late Filer")
                            {
                ...
                dtr["CPRNo"] = "NA";
                dtr["UniqIDSB"] = row.Cells["UniqIDSB"].Value.ToString();
                dt.Rows.Add(dtr);
                //}
            }
            grdCPRData.DataSource = dt.DefaultView;
            ///////////////////////// Drop Down Column//////////////////////////
            //GridViewComboBoxColumn comboColumn = new GridViewComboBoxColumn("CNIC");
            ////set the column data source - the possible column values
            //comboColumn.DataSource = dt;//new String[] { "Buyer" };
            //                            //set the FieldName - the column will retrieve the value from "Phone" column in the data table
            //comboColumn.ValueMember = "CNIC";
            //comboColumn.DisplayMember = "CNIC";
            //comboColumn.FieldName = "CNIC";
            //comboColumn.Name = "CNIC";
            //comboColumn.HeaderText = "CNIC";
            //comboColumn.Width = 240;
            ////comboColumn.ReadOnly = true;
            ////add the column to the grid
            //grdCPRData.Columns.Add(comboColumn);
            ////this.grdCPRData.Columns.Move(0,3)

            //GridViewTextBoxColumn txttype = new GridViewTextBoxColumn();
            //txttype.Name = "Type";
            //txttype.HeaderText = "Type";
            //txttype.FieldName = "Type";
            //txttype.Width = 60;
            //txttype.TextAlignment = ContentAlignment.BottomRight;
            //this.grdCPRData.MasterTemplate.Columns.Add(txttype);

            //GridViewTextBoxColumn txtname = new GridViewTextBoxColumn();
            //txtname.Name = "Name";
            //txtname.HeaderText = "Name";
            //txtname.FieldName = "Name";
            //txtname.Width = 60;
            //txtname.TextAlignment = ContentAlignment.BottomRight;
            //this.grdCPRData.MasterTemplate.Columns.Add(txtname);

            //GridViewTextBoxColumn textcpramount = new GridViewTextBoxColumn();
            //textcpramount.Name = "CPRAmount";
            //textcpramount.HeaderText = "CPR Amount";
            //textcpramount.FieldName = "CPRAmount";
            //textcpramount.Width = 120;
            //textcpramount.TextAlignment = ContentAlignment.BottomRight;
            //this.grdCPRData.MasterTemplate.Columns.Add(textcpramount);

            //GridViewTextBoxColumn txtcprno = new GridViewTextBoxColumn();
            //txtcprno.Name = "CPRNo";
            //txtcprno.HeaderText = "CPR No.";
            //txtcprno.FieldName = "CPRNo";
            //txtcprno.Width = 120;
            //txtcprno.TextAlignment = ContentAlignment.BottomRight;
            //this.grdCPRData.MasterTemplate.Columns.Add(txtcprno);
            ...
            //this.grdCPRData.MasterTemplate.Columns.Add(dateTimeColumn);
                ...
                else
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (tabControl1.TabPages.Contains(tp_Single_SellerBuyer))
                        {
                            ...
                            frmNDCCreate obj = new frmNDCCreate();
                            obj.Text = "NDC Modify";
                        }
        ...
        private void btnNDCCreate_Click(object sender, EventArgs e)
        {
            NDCAdd_OR_Update();
        }
        private void NDCAdd_OR_Update()
        {
            try
            {
                if (NDCID == 0)
                {
                    ...
                    {
                     new SqlParameter("@Task","insert"),
                     new SqlParameter(){ ParameterName = "@tbl_NDC",SqlDbType = SqlDbType.Structured, SqlValue = NDC_Table()},
                     new SqlParameter(){ ParameterName = "@tbl_File_Seller_Buyer",SqlDbType = SqlDbType.Structured, SqlValue = File_Seller_Buyer_Table()}
                    };
                    int rslt = 0;
                ...
                else
                {
                    ...
                    #region Update Single Seller -- Single Buyer
                    //    SqlParameter[] prmtr =
                    //    {
                    //    new SqlParameter("@Task","update"),
                    //    new SqlParameter("@NDCNo",NDCID),
                    //    new SqlParameter("@FileNo",txtFile_No.Text),
                    //    new SqlParameter("@MSNO",txt_Membership_No.Text),
                    //    new SqlParameter("@DateIssue",dtpIssueDate.Value.Date),
                    //    new SqlParameter("@Name_Seller",txtSellerName.Text),
                    //    new SqlParameter("@Seller_Father_Husband",txtSelrFatherName.Text),
                    //    new SqlParameter("@DHAP_Challan_No",txtDHAPChNo.Text),
                    //    new SqlParameter("@Seller_Amount",txtSellerAmount.Text),////////////////////////////////
                    //    new SqlParameter("@Seller_Account_No",txtSelerAccNo.Text),
                    //    new SqlParameter("@Purchaser_Name",txtprcsrName.Text),
                    //    new SqlParameter("@Purchaser_Father_Husband",txtPrcsrFatrName.Text),
                    //    new SqlParameter("@DDNoPOReceipt",txtDDNo.Text),
                    //    new SqlParameter("@Purchaser_Amount",txtChalnAmount.Text),
                    //    new SqlParameter("@Purchase_Account_No",txtPrcsrACCNo.Text),
                    //    new SqlParameter("@Payment_Date",dtpPaymntDate.Value.Date),
                    //    new SqlParameter("@Street_LaneNo",txtStreetNo.Text),
                    //    new SqlParameter("@Sector",txtSector.Text),
                    //    new SqlParameter("@Phase",txtPhase.Text),
                    //    new SqlParameter("@WHTax_us_236_C_Amount",txtWHTc.Text),
                    //    new SqlParameter("@WHTax_us_236_K_Amount",txtWHTk.Text),
                    //    new SqlParameter("@StampDuty",txtStampDuty.Text),
                    //    new SqlParameter("@Bank",txtBank.Text),
                    //    new SqlParameter("@Remarks",txtRemarks.Text),
                    //    new SqlParameter("@dtpNDCExpire ",dtpNDCExpire.Value.Date.ToString("dd/MM/yyyy")),
                    //    new SqlParameter("@StatusofNDC ","Incomplete"),
                    //    new SqlParameter("@userID",Models.clsUser.ID)
                    //};
                    //        int result = 0;
                    //        result = cls_dl_NDC.NdcNonQuery(prmtr);
                    //        if (result > 0)
                    //        {
                    //            MessageBox.Show("Update Successfully.");
                    //            this.Close();
                    //            //frmCheckListFilling frmObj = new NDC_CheckList.frmCheckListFilling();
                    //            //frmObj.ShowDialog();
                    //        }
                    #endregion
                }
            ...
            {
                frmExceptionCatched frmobj = new frmExceptionCatched("Exception is through on NDCAdd_OR_Update.", ex, "frmNDCCreate");
                frmobj.ShowDialog();
            }
        }
        private void PreventAgainApply()
        {
            try
            {
                SqlParameter[] prm =
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    MessageBox.Show("This FileNo is already Engage in Another NDC.");
                    grp_NDC.Enabled = false;
                }
                else
                {
                    grp_NDC.Enabled = true;
                }
            }
            catch (Exception ex)
            {
        ...
        private DataTable NDC_Table()
        {
            ...
            try
            {
                ...
                DataTable_column WHTax_us_236_K_Amount = new DataTable_column() { ColmnName = "WHTax_us_236_K_Amount", type = typeof(string) };
                ...
                colmn.Add(Sector);
                colmn.Add(Phase);
                colmn.Add(WHTax_us_236_K_Amount);
                ...
                row["NDC_No"] = 0;
                row["DateIssue"] = dtpIssueDate.Value.Date;
                row["DHAP_Challan_No"] = txtDHAPChNo.Text;
                row["Seller_Amount"] = txtSellerAmount.Text;
                row["Seller_Account_No"] = txtSelerAccNo.Text;
                row["Purchaser_Amount"] = txtChalnAmount.Text;
                row["Purchase_Account_No"] = txtPrcsrACCNo.Text;
                row["DDNoPOReceipt"] = txtDDNo.Text;
                row["Bank"] = txtBank.Text;
                row["Purcsr_Payment_Date"] = dtpPaymntDate.Value.Date;
                row["FilePlotNo"] = txtFile_No.Text;
                row["Street_LaneNo"] = txtStreetNo.Text;
                row["Sector"] = txtSector.Text;
                row["Phase"] = txtPhase.Text;
                row["WHTax_us_236_K_Amount"] = txtWHTk.Text;
                row["WHTax_us_236_C_Amount"] = txtWHTc.Text;
                row["StampDuty"] = txtStampDuty.Text;
                row["FileKey"] = FileKeyID;
                row["userID"] = Models.clsUser.ID;
                row["Remarks"] = txtRemarks.Text;
                row["StatusofNDC"] = "Incomplete";
                row["NDCExpireDate"] = dtpNDCExpire.Value.Date.ToString("yyyy-MM-dd");
                row["stmpDutyID"] = stmdtID;
                NDCTbl.Rows.Add(row);
                #endregion
            }
            catch (Exception ex)
            {
                frmExceptionCatched frmobj = new frmExceptionCatched("Exception is through on NDC_Table.", ex, "frmNDCCreate");
                frmobj.ShowDialog();
            }

            return NDCTbl;
        }
        private DataTable File_Seller_Buyer_Table()
        {
            ...
            try
            {
                ...
                seller_row["SBID"] = 0;
                seller_row["MemberID"] = MSID;
                seller_row["MSNo"] = txt_Membership_No.Text;
                seller_row["Name"] = txtSellerName.Text;
                seller_row["Father_Husband_Name"] = txtSelrFatherName.Text;
                seller_row["Address"] = Present_Address;
                seller_row["CNIC"] = CNCINo;
                seller_row["Type"] = "Seller";
                File_Seller_Buyer_Tbl.Rows.Add(seller_row);
                DataRow Buyer_row = File_Seller_Buyer_Tbl.NewRow();//Create Row for Buyer Data
                Buyer_row["SBID"] = 0;
                Buyer_row["MemberID"] = 0; // Here MemberID and MSNo is null because at NDC creation time, the Buyer has no MemebershipNo and ID , and at this time the Buyer has Challan
                Buyer_row["MSNo"] = ""; // and on the Bases of challan he is identify.
                Buyer_row["Name"] = txtprcsrName.Text;
                Buyer_row["Father_Husband_Name"] = txtPrcsrFatrName.Text;
                Buyer_row["Address"] = txtBuyerAddress.Text;
                Buyer_row["CNIC"] = txtBuyerCNIC.Text;
                Buyer_row["Type"] = "Buyer";
                File_Seller_Buyer_Tbl.Rows.Add(Buyer_row);
                #endregion
            }
            catch (Exception ex)
            {
        ...
        private void txt_Membership_No_Leave(object sender, EventArgs e)
        {
            try
            {
                SqlParameter[] prm =
                ...
                DataSet dst_1 = new DataSet();
                dst_1 = cls_dl_NDC.NdcRetrival(prm);
                if (dst_1.Tables[0].Rows.Count > 0)
                {
                    MSID = int.Parse(dst_1.Tables[0].Rows[0]["ID"].ToString());
                }
            }
            catch (Exception ex)
            {
                frmExceptionCatched frmobj = new frmExceptionCatched("Exception is through on txt_Membership_No_Leave.", ex, "frmNDCCreate");
                frmobj.ShowDialog();
            }
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            if (txtFile_No.Text != "")
            {
                urgentNDC_Check = chk_urgentNDC.Checked ? "Yes" : "No";
                urgentTFR_Check = chk_UrgentTransfer.Checked ? "Yes" : "No";
                OutStationCHarges_Check = chk_OutStationCharges.Checked ? "Yes" : "No";

                ReConsilation(txtFile_No.Text);
                Select_CurrentOwner_Info_Against_FileNo();
                PreventAgainApply();
                CheckCaution();
            }
            else
            {
                MessageBox.Show("Please select Date and File No Both.");
            }
        }
        ...
        private void Select_CurrentOwner_Info_Against_FileNo()
        {
            // bool blvr = false;
            try
            {
                SqlParameter[] prm =
                {
                new SqlParameter("@Task","Select_CurrentOwner_Info_Against_FileNo_Single"),//Select_CurrentOwner_Info_Against_FileNo_Single
                new SqlParameter("@FileNo",txtFile_No.Text),
                //new SqlParameter("@DateForSurchargeCalculation",dtp_dateOfSurchargeCalculation.Value),
                new SqlParameter("@UrgentNDCFee",urgentNDC_Check),
                new SqlParameter("@UrgentTFRFee",urgentTFR_Check),
                new SqlParameter("@OutStationCharges",OutStationCHarges_Check)
                };
                DataSet ds = cls_dl_NDC.NdcRetrival(prm);
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Columns.Count == 12) // If the Dues are Remaning
                    {
                        ...
                        if (txtFile_No.Text.ToUpper().Contains("B/RES/") || txtFile_No.Text.ToUpper().Contains("OLO/B/RES/"))
                        {
                            stampDutyAmount = 6000;

                        }
                        else if (txtFile_No.Text.ToUpper().Contains("C/RES/") || txtFile_No.Text.ToUpper().Contains("OLO/C/RES/") || txtFile_No.Text.ToUpper().Contains("C/RES/APS"))
                        {
                            stampDutyAmount = 3000;

                        }
                        else if (txtFile_No.Text.ToUpper().Contains("E/RES/") || txtFile_No.Text.ToUpper().Contains("OLO/E/RES/"))
                        {
                            stampDutyAmount = 1500;
                        ...
                        //     ) == DialogResult.Yes )
                        // {
                        //DataTable dtb = Installment_Surcharge_Detail_For_Report_Table(dueamount, receamount, remainInstAmount, dueSurcharge, recSurcharge, waveOffSurcharge, remainSurcharge, tfrFee, utfrFee, osCharges, undcFee, TotalDueRemaining, stampDutyAmount);

                        //dstdst.Merge(dtb);
                        //frm_SurchargInstallmentInfoDetailReport_ForNDC frmdt = new frm_SurchargInstallmentInfoDetailReport_ForNDC(dstdst);
                        //frmdt.ShowDialog();
                        ////}
                        //btnNDCCreate.Enabled = false;
                    }

                    else if (ds.Tables[0].Columns.Count > 12) // When the Dues are not Remaining and Pay Complete.
                    {
                        if (ds.Tables[0].Rows.Count > 0) // When the Dues are not Remaining and Pay Complete.
                        {
                            ...
                            if (ds.Tables[1].Rows.Count > 0) // Check For the Current Owner
                            {
                                if (int.Parse(ds.Tables[1].Rows[0]["OwnerCount"].ToString()) > 0) // If the Current Owner is Exist
                                {
                                    grpCheckChallanNo.Enabled = true;
                                    grpBuyerInfo.Enabled = true;
                                    grp_SaveButton.Enabled = true;
                                    FileKeyID = int.Parse(ds.Tables[0].Rows[0]["FileMapKey"].ToString());
                                    MSID = int.Parse(ds.Tables[0].Rows[0]["ID"].ToString());
                                    txt_Membership_No.Text = ds.Tables[0].Rows[0]["MembershipNo"].ToString();
                                    txtSellerName.Text = ds.Tables[0].Rows[0]["Name"].ToString();
                                    dtpPaymntDate.Value = Convert.ToDateTime(ds.Tables[0].Rows[0]["LastDD_Date"].ToString());
                                    txtSelrFatherName.Text = ds.Tables[0].Rows[0]["Father"].ToString();
                                    CNCINo = ds.Tables[0].Rows[0]["SellerNICNo"].ToString();
                                    Present_Address = ds.Tables[0].Rows[0]["PresentAddress"].ToString();
                                    txtDDNo.Text = ds.Tables[0].Rows[0]["DDNo"].ToString();
                                    txtSellerAmount.Text = ds.Tables[0].Rows[0]["Seller_Amount"].ToString();
                                    txtDHAPChNo.Text = ds.Tables[0].Rows[0]["ChalanNo"].ToString();
                                    txtChalnAmount.Text = ds.Tables[0].Rows[0]["ChallanAmount"].ToString();
                                    txtBank.Text = ds.Tables[0].Rows[0]["ChallanBank"].ToString();
                                    txtSelerAccNo.Text = ds.Tables[0].Rows[0]["InstNo"].ToString();
                                    txtPrcsrACCNo.Text = ds.Tables[0].Rows[0]["Particular"].ToString();
                                    txtBuyerAddress.Text = ds.Tables[0].Rows[0]["PresentAddress"].ToString();
                                }
                                else
                                {
                        ...
                        {
                            MessageBox.Show("Please Submit Transfer Fee."
                          + Environment.NewLine + " OR" + Environment.NewLine + "You does't Submit any Installment."
                          + Environment.NewLine + " OR" + Environment.NewLine + "There is no Current Owner Against this File No.",
                ...
                {
                    MessageBox.Show("Error !!! Please Contact with administration.");
                }
        ...
        private void btn_LastInstallmentVerfy_Click(object sender, EventArgs e)
        {
            try
            {
                SqlParameter[] prm =
                                      {
                new SqlParameter("@Task","Check_Last_Installment_Aganist_FileNo_MSNo"),
                new SqlParameter("@DDNo",txtDHAPChNo.Text),
                new SqlParameter("@FileKeyID",FileKeyID),
                new SqlParameter("@MemberID",MSID)
            };
                DataSet ds = new DataSet();
                ds = cls_dl_InstRece.Inst_Rece_Read(prm);
                if (ds.Tables[0].Rows.Count > 0)
                {
                ...
                {
                    MessageBox.Show("There is no nstallment Exist.");
                    grp_NDC.Enabled = false;
                }
            }
            catch (Exception ex)
            {
                frmExceptionCatched frmobj = new frmExceptionCatched("Exception is through on btn_LastInstallmentVerfy_Click.", ex, "frmNDCCreate");
                frmobj.ShowDialog();
            }

        }
        private void btn_Vrfy_ChallanNo_Click(object sender, EventArgs e)
        {
            try
            {
                SqlParameter[] prm =
                {
                new SqlParameter("@Task","Check_Challan_Exist_Or_Not"),
                new SqlParameter("@ChallanNo",txtDHAPChNo.Text),
                new SqlParameter("@FileMapKey",FileKeyID)
                };
                DataSet ds = new DataSet();
                ds = cls_dl_ChallanRece.ChallanRece_Reader(prm);
                if (int.Parse(ds.Tables[0].Rows[0]["ChallanExist"].ToString()) > 0)
                {
                    grpBuyerInfo.Enabled = true;
                    txtBank.Text = ds.Tables[0].Rows[0]["Bank"].ToString();
                    txtChalnAmount.Text = ds.Tables[0].Rows[0]["Amount"].ToString();
                }
                else
                {
                    MessageBox.Show("Please Submit Your Challan, Because we don't recieve your Challan.");
                    //grp_NDC.Enabled = false;
                }
            }
            catch (Exception ex)
            {
                frmExceptionCatched frmobj = new frmExceptionCatched("Exception is through on btn_Vrfy_ChallanNo_Click.", ex, "frmNDCCreate");
                frmobj.ShowDialog();
            }
        ...
        {
            string chalanNo = txtDHAPChNo.Text;
            frmChallanSearch frmobj = new frmChallanSearch(chalanNo);
            frmobj.ShowDialog();
        }
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Columns.Count == 14) // If the Dues are Remaning
                    {
                       ...
                       // }
                        ...
                        if (Math.Round(dueamount) == TotalAmount)
                        { } else { /*dueamount = TotalAmount;*/ MessageBox.Show("Invalid Installment Due Calculation.Contact with MIS Branch."); return; }
                        ...
                        if (Math.Round(remainInstAmount) == DueRemaingAmount || receamount > TotalAmountOfPlan) { } else { /*remainInstAmount = DueRemaingAmount;*/ MessageBox.Show("Invalid Total Remaining Installment Calculation.Contact with MIS Branch."); return; }
                        ...
                        if (remainInstAmount < 0) { remainInstAmount = 0; }
                        if (MembershipFormFeeSkipInclude_ == "SkipMembershipFormFee")
                        {
                            membershipFee = 0.00;
                            membershipFormFee = 0.00;
                        }
                        #endregion
                ...
                else
                {
                    if (txtFile_No_.Text.ToUpper().Contains("/COM/"))
                    {
                        if (string.IsNullOrEmpty(sector))
                        {
                            ...
                            stampDutyAmount = (Convert.ToInt32(psize * FBRvalueperMarla)) - Convert.ToInt32(stmdtyfee_minus);
                        }
                        else
                        {
                            if (sector == "ABC")
                    ...
                    //    stampDutyAmount = Convert.ToDouble(TotalAmount - stmdtyfee_minus);
        ...
        private void btn_Vrfy_ChallanNo__Click(object sender, EventArgs e)
        {
            try
            {
                SqlParameter[] prm =
                {
                new SqlParameter("@Task","Check_Challan_Exist_Or_Not"),
                new SqlParameter("@ChallanNo",txtDHAPChNo_),
                new SqlParameter("@FileMapKey",FileKeyID)
                };
                DataSet ds = new DataSet();
                ds = cls_dl_ChallanRece.ChallanRece_Reader(prm);
                if (int.Parse(ds.Tables[0].Rows[0]["ChallanExist"].ToString()) > 0)
                {
                    ...
                    grpBInfo.Enabled = true;
                    txtBank_ = ds.Tables[0].Rows[0]["Bank"].ToString();
                    txtChalnAmount_ = ds.Tables[0].Rows[0]["Amount"].ToString();
                }
                else
                {
                    MessageBox.Show("Please Submit Your Challan, Because we don't recieve your Challan.");
            ...
            {
                frmExceptionCatched frmobj = new frmExceptionCatched("Exception is through on btn_Vrfy_ChallanNo__Click.", ex, "frmNDCCreate");
                frmobj.ShowDialog();
            }
        ...
        private void btnNDCCreate__Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (NDCID == 0)
                {
                    ...
                    if (txtStampDuty_.Text != "" && txtDDNo_ != "" && txtDHAPChNo_ != "" && (buyerCheckFiler == true || buyerCheckLateFiler == true || buyerCheckNonFiler == true) && (sellerrCheckFiler == true || sellerrCheckNonFiler == true || sellerrCheckLateFiler == true))
                    {
                        try
                        {
                ...
                else
                {
                    ...
                    // new SqlParameter(){ ParameterName = "@tbl_File_Seller_Buyer",SqlDbType = SqlDbType.Structured, SqlValue = File_Seller_Buyer_Table_()}
                    // };
                    string ndcType = rdbHiba.IsChecked ? "Hiba" : "Normal";
        ...
        private void grdSeller_Buyer_CellClick(object sender, GridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.Column.Name == "mdfy_dmy_buyer")
                {
                    ...
                    buyerCheckLateFiler = false;
                    buyerCheckNonFiler = false;
                    sellerrCheckFiler = false;
                    sellerrCheckLateFiler = false;
        ...
        private void Clear_()
        {
            ...
            txtPhase.Text = "";
            txtStampDuty.Text = "";
            txt_Membership_No.Text = "";
            txtSellerName.Text = "";
            txtSelrFatherName.Text = "";
            txtprcsrName.Text = "";
            txtPrcsrFatrName.Text = "";
            txtBuyerAddress.Text = "";
            txtBuyerCNIC.Text = "";
            txtDealValue.Text = "";

        }
        private void drp_StmpDuty_RefNo_SelectedIndexChanged(object sender, Telerik.WinControls.UI.Data.PositionChangedEventArgs e)
        {
            if (drp_StmpDuty_RefNo.SelectedIndex > 0)
            {
                string stmstr = drp_StmpDuty_RefNo.SelectedItem.ToString();
                ...
                {
                    txtStampDuty.Text = array[0].ToString();
                    stmdtID = int.Parse(array[1].ToString());
                }
            }
            else
            {
        ...
        private void txtBuyerCNIC_Leave(object sender, EventArgs e)
        {
            string cnic = txtBuyerCNIC.Text;
            Bind_Stamp_Duty_Ref(cnic, txtFile_No.Text);
        }
        ...
        private void txtWHTc_Leave(object sender, EventArgs e)
        {
            SqlParameter[] prm =
            {
            ...
            if (dst.Tables.Count > 0)
            {
                ...
                {
                    btnNDCCreate.Enabled = false;
                    txtWHTk.Enabled = false;
                    MessageBox.Show(dst.Tables[0].Rows[0]["CPR_Status"].ToString());
                }
                else
                {
                    txtWHTk.Enabled = true;
                    btnNDCCreate.Enabled = true;
                }
            }
            else
            {
        ...
        private void txtWHTk_Leave(object sender, EventArgs e)
        {
            SqlParameter[] prm =
            {
        ...
        //private string FBRCalculationSeller(string cnic, string type)
        //{
        //    SqlParameter[] prm =
        //    {
        //        new SqlParameter("@Task","FBR_Taxes_Calculation"),
        //        new SqlParameter("@cnic",cnic),
        //        new SqlParameter("@Ownertype",type)
        //        };
        //    DataSet dst = new DataSet();
        //    dst = cls_dl_NDC.NdcRetrival(prm);
        //    string clc = dst.Tables[0].Rows[0]["WHTaxC"].ToString();
        //    return clc;
        //}
        //private string FBRCalculationBuyer(string cnic, string type)
        //{
        //    SqlParameter[] prm =
        //    {
        //        new SqlParameter("@Task","FBR_Taxes_Calculation"),
        ...
        //    DataSet dst = new DataSet();
        //    dst = cls_dl_NDC.NdcRetrival(prm);
        //    string clc = dst.Tables[0].Rows[0]["WHTaxK"].ToString();
        //    return clc;
        //}
        ...
        private DataTable StampDuty_Table_SellerBuyer()
        {
            ...
            try
            {
                ...
                for (int dr = 0; dr < rowcount; dr++)
                {
                    ...
                    row["CNIC"] = grdSeller_Buyer.Rows[dr].Cells["CNIC"].Value.ToString();
        ...
        private void StampDutyCalcuation(string FileNo, DataTable dt)
        {
            ...
            if (dst.Tables.Count > 0)
            {
                ...
                else if (FileNo.ToUpper().Contains("V/COM/") || FileNo.ToUpper().Contains("OLO/V/COM/"))
                {
                    dt.Rows[0]["Amount"] = int.Parse("20000") - int.Parse(txtStmDtyFee_minus.Text);
                    dt.Rows[0]["Amount_In_Words"] = clsPluginHelper.Convert_Number_To_Text(int.Parse("20000") - int.Parse(txtStmDtyFee_minus.Text), false);
                }
            }
            else
            {
                ...
                //if (string.IsNullOrEmpty(lblChallanNo.Text.Trim()))
                {
                    ...
                    int ChallanIDOut = 0;
                    {
                        ...
                        if (TotalAmount > 0)
                        {
                            ...
                            string cnic = grdSeller_Buyer.Rows[1].Cells["CNIC"].Value.ToString();
                    ...
                    if (slrbyrType.Contains("Buyer"))
                    {
                        ...
                        for (int i = 0; i < rowcount; i++)
                        {
                            ...
                            if (type == "Buyer")
                            {
                                ...
                                CNIC = grdSeller_Buyer.Rows[i].Cells["CNIC"].Value.ToString() + ",";
                            }
                        }
        ...
        private void btnrefres_Click(object sender, EventArgs e)
        {
            try
            {
                foreach (GridViewRowInfo rowInfo in grdSeller_Buyer.Rows)
                {
                    ...
                    if (typ == "Buyer")
                    {
                        string nic = rowInfo.Cells["CNIC"].Value.ToString();
                        Bind_Stamp_Duty_Ref(nic, txtFile_No_.Text);
                    }
                }
            }
                ...
                if (grdCPRData.RowCount > 0 || txtDealValue.Text == "")
                {
                    ...
                    if (NDCID <= 0)
                    {
                        ...
                        if (grdCPRData.RowCount > 0)
                        {
                            ...
                            {
                                buyerCheckFiler = true;
                                buyerCheckLateFiler = true;
                                buyerCheckNonFiler = true;
                                sellerrCheckFiler = true;
                                sellerrCheckLateFiler = true;
                                sellerrCheckNonFiler = true;
                                ...
                                //'txtDealValue.Text = decimal  = Convert.ToDecimal(60000000); //Testing case for checking fbr deal value percentage
                            ...
                            else
                            {
                                if (string.IsNullOrEmpty(CheckCPRDuplicate()))
                                {
                                    ...
                                    //@@@@@@@@@@@@@@@@@@@@@@@@@   Buyer Part / Late Filer @@@@@@@@@@@@@@@@@@@@@@@@@@@
                                    else if (sdt.Tables[0].Rows[0]["FBROwnerType"].ToString() == "Late Filer")
                                    {
                                        ...
                                        CalculatedTaxBuyerFBROwnerType = "Late Filer";
                                        ...
                                        else
                                        {
                                            ...
                                            MessageBox.Show("Buyer is not Valid to Purchase the File/Plot," + Environment.NewLine +
                                                         ...
                                                         + FBRtaxPercentage + " On deal value for Late Filer Buyer is : " + Math.Round(CalculatedTaxBuyer).ToString() + Environment.NewLine +
                                                         "and you are Submit :" + Math.Round(txtTaxKAmountBuyer), "Information !", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                                        }
                                        #endregion
                                    ...
                                    else if (sdt.Tables[0].Rows[0]["FBROwnerType"].ToString() == "Non-Filer")
                                    {
                                        ...
                                        {
                                            buyerCheckNonFiler = false;
                                            // MessageBox.Show($"Buyer is not Valid to Purchase the File/Plot,{Environment.NewLine}Because Deal Value is: {Math.Round(dealval).ToString()}{Environment.NewLine} {(FBRtaxPercentage).ToString()} On deal value for Non-Filer Buyer is :{Math.Round(CalculatedTaxBuyer).ToString()}{Environment.NewLine} and you are Submit : {Math.Round(txtTaxKAmountBuyer)}", "Information !", MessageBoxButtons.YesNo,MessageBoxIcon.Information);
                                            MessageBox.Show("Buyer is not Valid to Purchase the File/Plot," + Environment.NewLine +
                                                         "Because Deal Value is : " + Math.Round(dealval).ToString() + Environment.NewLine +
                                                         FBRtaxPercentage + " On deal value for Non-Filer Buyer is : " + Math.Round(CalculatedTaxBuyer).ToString() + Environment.NewLine +
                                                         "and you are Submit :" + Math.Round(txtTaxKAmountBuyer), "Information !", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                                        }
                                        #endregion
                                        ...
                                        if (chkFBRSellerSkip.CheckState == CheckState.Unchecked)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                MessageBox.Show("Seller is not valid to Sold the Plot,  " + st + Environment.NewLine +
                                                    "Because Deal Value is : " + Math.Round(dealval).ToString() + Environment.NewLine +
                                                    FBRtaxPercentage + "Tax Amount of " + Math.Round(dealval).ToString() + " is : " + Math.Round(CalculatedTaxSeller) + Environment.NewLine +
                                                    "Submitted Tax Amount is : " + Math.Round(txtTaxCAmountSeller) + Environment.NewLine +
                                                    "Which is less then the Calculated " + FBRtaxPercentage + " Tax Amount.", "Information !", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                                                //btnNDCCreate_.Enabled = false;
                                                txtTaxCAmountSeller = 0;
                                                txtTaxKAmountBuyer = 0;
                                            }
                                    ...
                                    else if (sdt.Tables[1].Rows[0]["FBROwnerType"].ToString() == "Late Filer")
                                    {
                                    ...
                                    if ((buyerCheckFiler == true || buyerCheckLateFiler == true || buyerCheckNonFiler == true) && (sellerrCheckFiler == true || sellerrCheckLateFiler == true || sellerrCheckNonFiler == true))
                                    {
                                        ...
                                        foreach (GridViewRowInfo rowInfo in grdSeller_Buyer.Rows)
                                        {
                                            ...
                                            if (typ == "Buyer")
                                            {
                                                ...
                                                #endregion
                                                drfsb["UniqIDSB"] = rowInfo.Cells["UniqIDSB"].Value.ToString();
                                                //drfsb["CPRNo"] = txtWHTk_.Text;
                                                //drfsb["CPRTaxAmount"] = txtwhtkAmount.Text;
                                                //drfsb["CalculatedTaxOnDealAmount"] = CalculatedTaxBuyer;
        ...
        private void radButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Code for Fideral Excise Duty challan starts from here
                SqlParameter[] prmGOD =
                            {
                                new SqlParameter("@Task","GetOwnerDetailsForStampDuty"),
                                new SqlParameter("@FileNo",txtFile_No_.Text.Trim()),
                ...
                decimal TotalAmount = 00;
                decimal FBRvalueperMarla = 0;
                decimal percentageValue = 0.05m;
                if (txtFile_No_.Text.ToUpper().Contains("/COM/"))
                {
                    string SellerString = "";
                    string BuyerString = "";
                    decimal fberdealval = Convert.ToDecimal(txtDealValue.Text) - Convert.ToDecimal(txtFBRFee_minus.Text == "" ? "0" : txtFBRFee_minus.Text); ;
                    string FBRtaxPercentage = "";
                    foreach (GridViewRowInfo row in grdSeller_Buyer.Rows)
                    {
                        //bool bl = Convert.ToBoolean(row.Cells["SelectOwner"].Value);
                    ...
                    if (sdt.Tables[0].Rows[0]["FBROwnerType"].ToString() == "Filer")
                    {
                        ...
                        if (sector == "ABC")
                        {
                            ...
                            CalculatedTaxBuyer = (Convert.ToDecimal(ConfigurationManager.AppSettings["FBRValuePerMarla_ComABC"]) * Convert.ToDecimal(3)) / 100;
                            TotalAmount = psize * CalculatedTaxBuyer;
                            FBRtaxPercentage = "3%";

                        }
                        else
                        {
                            CalculatedTaxBuyer = (Convert.ToDecimal(ConfigurationManager.AppSettings["FBRValuePerMarla_ComOther"]) * Convert.ToDecimal(3)) / 100; //FBR Per Marla Value is  1250000
                            TotalAmount = psize * CalculatedTaxBuyer;
                            FBRtaxPercentage = "3%";
                        }
                        ...
                        else
                        {
                            ...
                            MessageBox.Show("Buyer is not Valid to Purchase the File/Plot," + Environment.NewLine +
                                        "Because Deal Value is : " + (fberdealval.ToString()) + Environment.NewLine
                    ...
                    else if (sdt.Tables[0].Rows[0]["FBROwnerType"].ToString() == "Late Filer")
                    {
                        ...
                        if (sector == "ABC")
                        {
                            ...
                            CalculatedTaxBuyer = (Convert.ToDecimal(ConfigurationManager.AppSettings["FBRValuePerMarla_ComABC"]) * Convert.ToDecimal(5)) / 100;
                            TotalAmount = psize * CalculatedTaxBuyer;
                            FBRtaxPercentage = "5%";
                        ...
                        {
                            CalculatedTaxBuyer = (Convert.ToDecimal(ConfigurationManager.AppSettings["FBRValuePerMarla_ComOther"]) * Convert.ToDecimal(5)) / 100; //FBR Per Marla Value is  1250000
                            TotalAmount = psize * CalculatedTaxBuyer;
                            FBRtaxPercentage = "5%";
                        }
                    ...
                    if (sdt.Tables[0].Rows[0]["FBROwnerType"].ToString() == "Non-Filer")
                    {
                        ...
                        if (sector == "ABC")
                        {
                            ...
                            CalculatedTaxBuyer = (Convert.ToDecimal(ConfigurationManager.AppSettings["FBRValuePerMarla_ComABC"]) * Convert.ToDecimal(7)) / 100;
                            TotalAmount = psize * CalculatedTaxBuyer;
                            FBRtaxPercentage = "7%";
                        ...
                        {
                            CalculatedTaxBuyer = (Convert.ToDecimal(ConfigurationManager.AppSettings["FBRValuePerMarla_ComOther"]) * Convert.ToDecimal(7)) / 100; //FBR Per Marla Value is  1250000
                            TotalAmount = psize * CalculatedTaxBuyer;
                            FBRtaxPercentage = "7%";
                        }
                        ...
                        else
                        {
                            ...
                            MessageBox.Show("Buyer is not Valid to Purchase the File/Plot," + Environment.NewLine +
                                        "Because Deal Value is : " + (fberdealval.ToString()) + Environment.NewLine
                                        + " 3 % On deal value for Filer Buyer  is : " + Math.Round(CalculatedTaxBuyer) + Environment.NewLine +
                                        "and you are Submit  :" + Math.Round(txtTaxKAmountBuyer), "Fideral Excise Duty !", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                        }
                        ...
                        param_out_ID
                            ...
                            if (result.Parameters.Count != 0)
                            {
                                ...
                                if (ChallanIDOut != 0)
                                {
                                    ...
                                    new SqlParameter("@Task","SaveChallanDetail"),
                                    new SqlParameter("@ChallanID", ChallanIDOut),
                                    new SqlParameter("@ParticularID", 1272),
                                    new SqlParameter("@ParticularAmount", TotalAmount),
                                    new SqlParameter("@UserID", Models.clsUser.ID),
                                    new SqlParameter("@SerialNo", 1),
                                    new SqlParameter("@Particular","Fideral Excise Duty"),
                                    new SqlParameter("@ChallanType",ChallanType )
                                    //ChallanType
                                };
                                    try
                ...
                {
                    MessageBox.Show("Fideral Excise Duty is only Applicable to Commercial File Transfer" , "Fideral Excise Duty !", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
