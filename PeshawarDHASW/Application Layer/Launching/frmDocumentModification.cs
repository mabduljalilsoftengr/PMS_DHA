...
{
    public partial class frmDocumentModification : Telerik.WinControls.UI.RadForm
    {
        public frmDocumentModification()
        {
            InitializeComponent();
        }
        ...
        private void DGV_CompleteForms_CellClick(object sender, Telerik.WinControls.UI.GridViewCellEventArgs e)
        {
            if (e.Column.Name == "btnViewImage")
            {
                ...
                frmDocPictureModify obj = new frmDocPictureModify(ApplicationID);
                obj.ShowDialog();
            }
        }

        private void frmDocumentModification_Load(object sender, EventArgs e)
        {
