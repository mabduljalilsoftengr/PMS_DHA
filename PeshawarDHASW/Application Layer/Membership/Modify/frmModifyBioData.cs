    ...
    public partial class frmModifyBioData : Telerik.WinControls.UI.RadForm
    {
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        bool rslt = clsPluginHelper.ApplicationLogSaving(txtFileNo.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "Before - Modification Membership BioInfo Record. ", ds, "frmModifyBioData - frmModifyBioData_Load", "DataSetTable");
                    }
                }
        ...
        private void ModifyMembershipInfo()
        {
            try
            {
                ...
                bool rslt = clsPluginHelper.ApplicationLogSaving(txtFileNo.Text, Models.clsUser.ID + "-" + clsUser.Name + "-" + branch, "After - Modification Membership BioInfo ", parameter1, "", "SQLParam");
                if (result > 0)
                {
                    this.Close();
                }
